    ...
    <section className="content-band">
      <div className="content-inner max-w-4xl">
        ...
        <p className="mt-6 max-w-2xl text-xl leading-9 text-ink-1">
          The query returns exactly the right rows. To get two columns it quietly read the whole table, and every
          check that watches correctness stays green.
        </p>
        ...
        <div className="mt-12">
          <Steps
            items={[
              {
                label: "data in",
                text: "A 200,000-row, 12-column table with a fixed byte width per column, modeled deterministically in your browser.",
              },
              {
                label: "check runs",
                text: "Your query and layout decide which column chunks get read. The guardrail compares bytes touched to what the projection needs; a correctness check watches the rows.",
              },
              {
                label: "verdict out",
                text: "The meter shows bytes read, and the banner says whether the read stayed inside budget.",
              },
            ]}
          />
        </div>
        ...
        <div className="mt-14 border-t border-rule">
          ...
          <Disclosure summary="The measured result: 44.7x over-read" defaultOpenDesktop>
            ...
            <div className="mt-6 rounded-lg border border-rule bg-bg-1/60 p-5 md:p-7">
              <div className="flex flex-wrap items-baseline justify-between gap-3">
                <h3 className="text-2xl text-ink-0">Same file, one query, read two ways</h3>
          ...
          <Disclosure summary="The full mechanism: why the usual check fails">
...
{`make setup && make test && make run   # $0, laptop, no GPU, no network`}
        ...
        <div className="mt-14 flex flex-wrap gap-6 border-t border-rule pt-8">
          <a
            ...
            href="https://github.com/coconut-labs/columnar-scan-bytes-guardrail"
          >
