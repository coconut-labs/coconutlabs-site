    ...
    <section className="content-band">
      <div className="content-inner max-w-4xl">
        ...
        <p className="mt-6 max-w-2xl text-xl leading-9 text-ink-1">
          Your new model scores 0.999 offline. That is not skill: the training table quietly joined in features from
          the future, and the metric you trust is rewarding the bug.
        </p>
        ...
        <div className="mt-12">
          <Steps
            items={[
              {
                label: "data in",
                text: "Eight labels, each with its own feature history, generated deterministically in your browser.",
              },
              {
                label: "check runs",
                text: "The join you pick builds the training table. The guardrail then checks one rule: no feature may be timestamped after its label.",
              },
              {
                label: "verdict out",
                text: "Leaked rows are marked line by line, and the banner totals them in plain words.",
              },
            ]}
          />
        </div>
        ...
        <div className="mt-14 border-t border-rule">
          ...
          <Disclosure summary="The measured result: AUC 0.999 vs 0.771" defaultOpenDesktop>
            ...
            <div className="mt-6 rounded-lg border border-rule bg-bg-1/60 p-5 md:p-7">
              <div className="flex flex-wrap items-baseline justify-between gap-3">
                <h3 className="text-2xl text-ink-0">Same data, joined two ways</h3>
          ...
          <Disclosure summary="Why accuracy can't catch this">
...
{`make setup && make test && make run   # $0, laptop, no GPU, no network`}
          ...
          <Disclosure summary="A leak inside the anti-leak join">
        ...
        <div className="mt-14 flex flex-wrap gap-6 border-t border-rule pt-8">
          <a
            ...
            href="https://github.com/coconut-labs/point-in-time-correctness-guardrail"
          >
