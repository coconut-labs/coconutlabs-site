...
// Direction A: research on the home page is three quiet rows, not cards.
    ...
    <section className="content-band">
      <div className="content-inner">
        <div className="mb-8 flex items-end justify-between gap-6">
          <div>
            <p className="font-mono text-[11px] uppercase tracking-[0.16em] text-ink-2">writing</p>
            <h2 className="mt-3 text-[clamp(1.6rem,3vw,2.4rem)] leading-tight tracking-[-0.03em]">Recent research</h2>
          </div>
